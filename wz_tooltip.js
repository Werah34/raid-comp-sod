...
config.BgColor = "#242424"; // Background colour (HTML colour value, in quotes)
config.BgImg = ""; // Path to background image, none if empty string ''
config.BorderColor = "#2E9ACC";
...
config.OffsetX = -480; // Horizontal offset of left-top corner from mousepointer
